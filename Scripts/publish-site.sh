...
rm -r "$SCRIPT_PATH"/../influxdb-client-swift/*

echo "# Copy new docs"
cp -Rf "$SCRIPT_PATH"/../docs/* "$SCRIPT_PATH"/../influxdb-client-swift/

echo "# Copy CircleCI"
cp -R "${SCRIPT_PATH}"/../.circleci/ "$SCRIPT_PATH"/../influxdb-client-swift/
